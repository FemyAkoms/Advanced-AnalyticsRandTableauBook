        ...
        <section class="my-4 sectionmarginright">
                                            ...
                                            <div>
                                                <div class="Input_Data_Form">
                                                    ...
                                                    <div class="modal  fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <input type="text" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Description" v-model="credit.regular_income.addData.description" style="width: 100%;" :style="[credit.error.description?{'border-color':'red'}:{}]"></td>
                                                                        </div>

                                                                        <div class="col-md-6">
                                                                          <input type="text" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Amount Owed" v-model="credit.regular_income.addData.amount" style="width: 100%;" :style="[credit.error.amount?{'border-color':'red'}:{}]">
                                                                      </div>
                                                                  </div>
                                                                  <div class="row">
                                                                   <div class="col-md-6">
                                                                       <select class="modalcontrol" v-model="credit.regular_income.addData.frequency" style="width: 100%;" :style="[credit.error.frequency?{'border-color':'red'}:{}]">
                                                                ...
                                                                <div class="col-md-6">
                                                                   <select class="modalcontrol" v-model="credit.regular_income.addData.income_type" style="width: 100%;" :style="[credit.error.income_type?{'border-color':'red'}:{}]">
                                                        ...
                                                        <div class="row">
                                                           <div class="col-md-6">
                                                               <vuejs-datepicker :language="en" placeholder="Start Date" class="form-control modalcontrol" v-model="credit.regular_income.addData.income_starts" :style="[credit.error.income_starts?{'border-color':'red'}:{}]"></vuejs-datepicker>

                                                               <!-- <input type="date" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Statement Date" v-model="credit.regular_income.addData.income_starts" style="width: 100%;" :style="[credit.error.income_starts?{'border-color':'red'}:{}]"></td> -->
                                                           </div>
                                                           <div class="col-md-6">
                                                               <vuejs-datepicker :language="en" placeholder="Payment Due Date" class="form-control modalcontrol" v-model="credit.regular_income.addData.income_ends" :style="[credit.error.income_ends?{'border-color':'red'}:{}]"></vuejs-datepicker>

                                                               <!-- <input type="date" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Payment Due Date" v-model="credit.regular_income.addData.income_ends" style="width: 100%;" :style="[credit.error.income_ends?{'border-color':'red'}:{}]"></td> -->
                                                           </div>
                                                       </div>
                                                   </div>
                                                   <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <button type="button" class="btn btn-primary" @click.prevent="addCreditRegularIncome">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>   
                                ...
                                <div style="overflow-x:auto;">
                                    <table>
                                        <tr class="table_row_design">
                                            <th style="padding: 0px 50px;">DESCRIPTION</th>
                                            <th style="padding: 0px 50px;">AMOUNT</th>
                                            <th style="padding: 0px 50px;">FREQUENCY</th>
                                            <th style="padding: 0px 50px;">TYPE</th>
                                            <th style="padding: 0px 50px;">INCOME STARTS</th>
                                            <th style="padding: 0px 50px;">INCOME ENDS</th>
                                        ...
                                        <tr class="table_row_design1" v-for="(v,i) in filterpagination" :key='v.id'>
                                            <td style="padding: 0px 50px;"><span v-if="!v.edit">{{v.description}}</span><span v-if="v.edit"><input type="text" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Description" v-model="v.edit_description" style="width: 100%;" :style="[v.error.description?{'border-color':'red'}:{}]"></span></td>

                                            <td style="padding: 0px 50px;"><span v-if="!v.edit">
                                                   $ <span v-if="!v.amount">0</span> {{v.amount}}</span><span v-if="v.edit"><input type="text" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Amount" v-model="v.edit_amount" style="width: 100%;" :style="[v.error.amount?{'border-color':'red'}:{}]"></span></td>

                                            <td style="padding: 0px 50px;"><span v-if="!v.edit">{{v.frequency}}</span><span v-if="v.edit">
                                                ...
                                                <select class=" textmort1" v-model="v.edit_frequency" style="width: 100%;" :style="[v.error.frequency?{'border-color':'red'}:{}]">
                                                    <option disabled selected value> select frequency </option>
                                                    <option value="Monthly">Monthly</option>
                                                    <option value="Monthly">One-Time</option>
                                                    <option value="Yearly">Yearly</option>
                                            ...
                                            <td style="padding: 0px 50px;">
                                                <span v-if="!v.edit">{{v.income_type}} </span><span v-if="v.edit">
                                                    <select class=" textmort1" v-model="v.edit_income_type" style="width: 100%;" :style="[v.error.income_type?{'border-color':'red'}:{}]">
                                                        <option disabled selected value> select type </option>
                                                        <option value="Salary">Salary</option>
                                                        <option value="Rental Income">Rental Income</option>
                                                        <option value="Business Income">Business Income</option>
                                                ...
                                                <td style="padding: 0px 30px;"><span v-if="!v.edit">{{v.income_starts}}</span><span v-if="v.edit">
                                                    <vuejs-datepicker :language="en" placeholder="Income Starts" class="form-control modalcontrol" v-model="v.edit_income_starts" :style="[v.error.income_starts?{'border-color':'red'}:{}]"></vuejs-datepicker>

                                                    <!-- <input type="date" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Income Starts" v-model="v.edit_income_starts" style="width: 100%;" :style="[v.error.income_starts?{'border-color':'red'}:{}]"> -->
                                                </span></td>

                                                <td style="padding: 0px 30px;"><span v-if="!v.edit">{{v.income_ends}}</span><span v-if="v.edit">
                                                    <vuejs-datepicker :language="en" placeholder="Income Ends" class="form-control modalcontrol" v-model="v.edit_income_starts" :style="[v.error.income_ends?{'border-color':'red'}:{}]"></vuejs-datepicker>

                                                    <!-- <input type="date" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Income Ends" v-model="v.edit_income_ends" style="width: 100%;" :style="[v.error.income_ends?{'border-color':'red'}:{}]"> -->
                                                </span></td>
                                                <td>
                                                    <div class="d-flex bd-highlight ">
                                                        <div class="p-2 bd-highlight" @click.prevent="editCreditRegularIncome(v)" v-if="!v.edit" style="cursor:pointer"><i class="fas fa-pen-alt"></i> Edit</div>
                                                        <div class="p-2 bd-highlight" @click.prevent="saveCreditRegularIncome(v)" v-if="v.edit" style="cursor:pointer"><i class="fas fa-file-alt"></i> Save</div>
                                                        <div class="p-2 bd-highlight" @click.prevent="deleteCreditRegularIncome(v,i)" style="cursor:pointer"><i class="far fa-trash-alt"></i> Delete</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                            <!-- <td style="padding: 0px 10px;">
                                                                <input type="text" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Description" v-model="credit.regular_income.addData.description" style="width: 100%;" :style="[credit.error.description?{'border-color':'red'}:{}]"></td>
                                                            <td style="padding: 0px 10px;">
                                                                <input type="text" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Amount Owed" v-model="credit.regular_income.addData.amount" style="width: 100%;" :style="[credit.error.amount?{'border-color':'red'}:{}]"></td>
                                                                <td style="padding: 0px 10px;"> -->
                                                                    <!-- <input type="text" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Frequency" v-model="credit.regular_income.addData.frequency"> -->
                                                                <!-- <select class=" textmort1" v-model="credit.regular_income.addData.frequency" style="width: 100%;" :style="[credit.error.frequency?{'border-color':'red'}:{}]">
                                                                    <option disabled selected value> select frequency </option>
                                                                    <option value="Monthly">Monthly</option>
                                                                    <option value="Monthly">One-Time</option>
                                                                    <option value="Yearly">Yearly</option>
                                                            ...
                                                            <td style="padding: 0px 10px;">
                                                                <select class=" textmort1" v-model="credit.regular_income.addData.income_type" style="width: 100%;" :style="[credit.error.income_type?{'border-color':'red'}:{}]">
                                                                    <option disabled selected value> select type </option>
                                                                    <option value="Salary">Salary</option>
                                                                    <option value="Rental Income">Rental Income</option>
                                                                    <option value="Business Income">Business Income</option>
                                                            ...
                                                            <td style="padding: 0px 10px;">
                                                                <input type="date" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Statement Date" v-model="credit.regular_income.addData.income_starts" style="width: 100%;" :style="[credit.error.income_starts?{'border-color':'red'}:{}]"></td>
                                                            <td style="padding: 0px 10px;">
                                                                <input type="date" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Payment Due Date" v-model="credit.regular_income.addData.income_ends" style="width: 100%;" :style="[credit.error.income_ends?{'border-color':'red'}:{}]"></td> -->
                                                                <td>
                                                                    <!-- <button class="btn btnsuccessde" @click.prevent="addCreditRegularIncome">SAVE</button></td> -->
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </div>
            ...
            paginate: function(page) {
                ...
                for (var i = start - 10; i <= last - 10; i++) {
                    if (typeof(ths.credit.regular_income.data[i]) != "undefined")
                        ths.filterpagination.push(ths.credit.regular_income.data[i]);
                }
            },
            updateUserProfile: function() {
                ...
                getCreditRegularIncome: function() {
                    ...
                    .then(function(res) {
                        ...
                        $('.trans').fadeOut("slow");
                        this.isActive = false;
                        t.settings.count = Math.ceil(t.credit.regular_income.data.length / 10);
                ...
                addCreditRegularIncome: function() {
                    let t = this;
                    t.credit.regular_income.addData.income_starts=t.customFormatter(t.credit.regular_income.addData.income_starts);
                    t.credit.regular_income.addData.income_ends=t.customFormatter(t.credit.regular_income.addData.income_ends);
                ...
                saveCreditRegularIncome: function(d) {
                    let t=this;
                    d.edit_income_starts=t.customFormatter(d.edit_income_starts);
                    d.edit_income_ends=t.customFormatter(d.edit_income_ends);
                    ...
                    https.patch('inputs/creditcardtool/regular-income/' + d.id + '/', data)
                    .then(function(res) {
                        console.log(d);
                        if (res.hasValidationError) {
