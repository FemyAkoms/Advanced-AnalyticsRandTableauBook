                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Description" v-model="mortgage.lumbSumIncome.addlumbsumIncome.description" :style="[mortgage.error.description?{'border-color':'red'}:{}]">                                                                
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <input type="text" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Amount" v-model="mortgage.lumbSumIncome.addlumbsumIncome.amount" :style="[mortgage.error.amount?{'border-color':'red'}:{}]">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                             <vuejs-datepicker :language="en" placeholder="Injecting Date" class="form-control modalcontrol" v-model="mortgage.lumbSumIncome.addlumbsumIncome.when_injecting" :style="[mortgage.error.when_injecting?{'border-color':'red'}:{}]"></vuejs-datepicker>
                                                                         </div>
                                                                     </div>
                                                                 </div>
                                                                 <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    <button type="button" class="btn btn-primary" @click.prevent="addLumbSumIncome()">Save</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> 
                                                ...
                                                <div style="overflow-x:auto;">
                                                    <table>
                                                        ...
                                                        <tr class="table_row_design1" v-for="(item,i) in filterpagination" :key='item.id'>
                                                            ...
                                                            <td style="padding-left: 0; text-align: center;">
                                                                <span v-if="!item.edit"> {{item.when_injecting}}</span><span v-if="item.edit">
                                                                  <vuejs-datepicker :language="en" placeholder="Injecting Date" class="form-control modalcontrol" v-model="item.edit_when_injecting" :style="[item.error.when_injecting?{'border-color':'red'}:{}]"></vuejs-datepicker>
                                                              </span>
                                                          </td>
                                                          <td>
                                                            <div class="d-flex bd-highlight ">
                                                                <div class="p-2 bd-highlight" v-on:click="editLumbsumIncome(item)" v-if="!item.edit" style="cursor:pointer"><i class="fas fa-pen-alt"></i> Edit</div>
                                                                <div class="p-2 bd-highlight" v-on:click="saveLumbsumIncome(item)" v-if="item.edit" style="cursor:pointer"><i class="fas fa-pen-alt"></i> Save</div>
                                                                <div class="p-2 bd-highlight" style="cursor:pointer" v-on:click="deleteLumbsumInc(item,i)"><i class="far fa-trash-alt"></i> Delete</div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button class="btn btnsuccessde"><a href="Input_LumpSumExpenses" style="text-decoration: none;color: white">NEXT >></a></button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
    ...
    methods: {
        ...
        paginate: function(page) {
            ...
            for (var i = start - 10; i <= last - 10; i++) {
                if (typeof(ths.morLumbSumInc[i]) != "undefined")
                    ths.filterpagination.push(ths.morLumbSumInc[i]);
            }
        },
        ...
        mySubscription: function(){
                ...
                getLumbSumIncome: function() {
                    ...
                    .then(function(res) {
                        ...
                        $('.trans').fadeOut("slow");
                        this.isActive = false;
                        t.settings.count = Math.ceil(t.morLumbSumInc.length / 10);
                ...
                addLumbSumIncome: function() {
                    let t = this;
                    t.mortgage.lumbSumIncome.addlumbsumIncome.when_injecting=t.customFormatter(t.mortgage.lumbSumIncome.addlumbsumIncome.when_injecting);
                ...
                saveLumbsumIncome: function(value) {
                    let e = this;
                    value.edit_when_injecting=e.customFormatter(value.edit_when_injecting);
                    let data = {
                ...
                editLumbsumIncome: function(value) {
                    console.log(value);
