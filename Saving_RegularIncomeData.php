                                                        ...
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <input type="text" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Description" v-model="savings.regular_income.addData.description" :style="[savings.error.description?{'border-color':'red'}:{}]">
                                                                        </div>

                                                                        <div class="col-md-6">
                                                                          <input type="text" class="form-control modalcontrol" id="exampleFormControlInput1" placeholder="Amount" v-model="savings.regular_income.addData.amount" :style="[savings.error.amount?{'border-color':'red'}:{}]">

                                                                      </div>
                                                                  </div>
                                                                  <div class="row">
                                                                     <div class="col-md-6">
                                                                         <select class=" modalcontrol" v-model="savings.regular_income.addData.frequency" :style="[savings.error.frequency?{'border-color':'red'}:{}]">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                     <select class=" modalcontrol" v-model="savings.regular_income.addData.income_type" :style="[savings.error.income_type?{'border-color':'red'}:{}]">
                                                            ...
                                                            <div class="row">
                                                             <div class="col-md-6">
                                                                 <vuejs-datepicker :language="en" placeholder="Start Date" class="form-control modalcontrol"v-model="savings.regular_income.addData.income_starts" :style="[savings.error.income_starts?{'border-color':'red'}:{}]"></vuejs-datepicker>
                                                                 <!-- <input type="date" name="bday" class=" form-control modalcontrol" v-model="savings.regular_income.addData.income_starts" :style="[savings.error.income_starts?{'border-color':'red'}:{}]"> -->
                                                             </div>
                                                             <div class="col-md-6">
                                                                 <vuejs-datepicker :language="en" placeholder="End Date" class="form-control modalcontrol" v-model="savings.regular_income.addData.income_ends" :style="[savings.error.income_ends?{'border-color':'red'}:{}]"></vuejs-datepicker>
                                                                 <!-- <input type="date" name="bday" class="form-control modalcontrol" v-model="savings.regular_income.addData.income_ends" :style="[savings.error.income_ends?{'border-color':'red'}:{}]"> -->
                                                             </div>
                                                         </div>
                                                     </div>
                                                     <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                        <button type="button" class="btn btn-primary" @click.prevent="addSavingRegularIncome">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>   
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table>
                                            <tr class="table_row_design">
                                                ...
                                                <th style="padding: 0 50px;text-align: center;">TYPE</th>
                                            ...
                                            <tr class="table_row_design1" v-for="(v,i) in filterpagination" :key='v.id'>
                                                ...
                                                <td style="padding-left: 0; text-align: center;"><span v-if="!v.edit">{{v.frequency}}</span><span v-if="v.edit">
                                                    ...
                                                    <select style="margin: 0 auto;" class=" textmort1" v-model="v.edit_frequency" :style="[v.error.frequency?{'border-color':'red'}:{}]">
                                                ...
                                                <td style="padding-left: 0; text-align: center;"><span v-if="!v.edit">{{v.income_type}}</span><span v-if="v.edit">

                                                    <!-- <input type="text" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Frequency" v-model="v.edit_frequency"> -->
                                                    <select style="margin: 0 auto;" class=" textmort1" v-model="v.edit_income_type" :style="[v.error.income_type?{'border-color':'red'}:{}]">
                                                ...
                                                <td style="padding-left: 0; text-align: center;"><span v-if="!v.edit">{{v.income_starts}}</span><span v-if="v.edit">
                                                   <vuejs-datepicker :language="en" class="form-control modalcontrol" placeholder="Start Date" v-model="v.edit_income_starts" :style="[v.error.income_starts?{'border-color':'red'}:{}]"></vuejs-datepicker>

                                                   <!-- <input type="date" style="margin: 0 auto;" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="Start Date" v-model="v.edit_income_starts" :style="[v.error.income_starts?{'border-color':'red'}:{}]"> -->
                                               </span></td>
                                               <td style="padding-left: 0; text-align: center;"><span v-if="!v.edit">{{v.income_ends}}</span><span v-if="v.edit">

                                                <vuejs-datepicker :language="en" class="form-control modalcontrol" placeholder="End Date" v-model="v.edit_income_ends" :style="[v.error.income_ends?{'border-color':'red'}:{}]"></vuejs-datepicker>

                                                <!-- <input type="date" style="margin: 0 auto;" class="form-control control_input_from5" id="exampleFormControlInput1" placeholder="End Date" v-model="v.edit_income_ends" :style="[v.error.income_ends?{'border-color':'red'}:{}]"> -->
                                            </span></td>
                                            <td>
                                                <div class="d-flex bd-highlight ">
                                                    <div class="p-2 bd-highlight" @click.prevent="editSavingRegularIncome(v)" v-if="!v.edit" style="cursor:pointer"><i class="fas fa-pen-alt"></i> Edit</div>
                                                    <div class="p-2 bd-highlight" @click.prevent="saveSavingRegularIncome(v)" v-if="v.edit" style="cursor:pointer"><i class="fas fa-file-alt"></i> Save</div>
                                                    <div class="p-2 bd-highlight" @click.prevent="deleteSavingRegularIncome(v,i)" style="cursor:pointer"><i class="far fa-trash-alt"></i> Delete</div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                                            <!-- <td style="padding:0 30px">
                                                                <input type="text" class="form-control control_input_from1" id="exampleFormControlInput1" placeholder="Description" v-model="savings.regular_income.addData.description" :style="[savings.error.description?{'border-color':'red'}:{}]">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control control_input_from1" id="exampleFormControlInput1" placeholder="Amount" v-model="savings.regular_income.addData.amount" :style="[savings.error.amount?{'border-color':'red'}:{}]">
                                                            </td>
                                                            <td> -->
                                                                <!-- <input type="text" name="bday" class="form-control control_input_from1" v-model="savings.regular_income.addData.frequency"> -->
                                                                <!-- <select class=" textmort1" v-model="savings.regular_income.addData.frequency" :style="[savings.error.frequency?{'border-color':'red'}:{}]">
                                                                    <option disabled selected value> select frequency </option>
                                                                    <option value="Monthly">Monthly</option>
                                                                    <option value="Monthly">One-Time</option>
                                                                    <option value="Yearly">Yearly</option>
                                                            ...
                                                            <td> -->
                                                                <!-- <input type="text" name="bday" class="form-control control_input_from1" v-model="savings.regular_income.addData.frequency"> -->
                                                                <!-- <select class=" textmort1" v-model="savings.regular_income.addData.income_type" :style="[savings.error.income_type?{'border-color':'red'}:{}]">
                                                                    <option disabled selected value> select type </option>
                                                                    <option value="Salary">Salary</option>
                                                                    <option value="Rental Income">Rental Income</option>
                                                                    <option value="Business Income">Business Income</option>
                                                            ...
                                                            <td>
                                                                <input type="date" name="bday" class=" form-control control_input_from1" v-model="savings.regular_income.addData.income_starts" :style="[savings.error.income_starts?{'border-color':'red'}:{}]">
                                                            </td>
                                                            <td>
                                                                <input type="date" name="bday" class="form-control control_input_from1" v-model="savings.regular_income.addData.income_ends" :style="[savings.error.income_ends?{'border-color':'red'}:{}]">
                                                            </td> -->
                                                            <td>
                                                                <!-- <button class="btn btnsuccessde" @click.prevent="addSavingRegularIncome">ADD</button> -->
                                                                <button class="btn btnsuccessde"><a href="Saving_RegularExpensedData" style="text-decoration: none;color: white">NEXT >></a></button>
                                                            </td>
                                                        </tr>
        ...
        mounted: function() {
            ...
            paginate: function(page) {
                ...
                for (var i = start - 10; i <= last - 10; i++) {
                    if (typeof(ths.savings.regular_income.data[i]) != "undefined")
                        ths.filterpagination.push(ths.savings.regular_income.data[i]);
                }
            },
            updateUserProfile: function() {
                ...
                getSavingRegularIncome: function() {
                    ...
                    .then(function(res) {
                        ...
                        $('.trans').fadeOut("slow");
                        this.isActive = false;
                        t.settings.count = Math.ceil(t.savings.regular_income.data.length / 10);
                ...
                addSavingRegularIncome: function() {
                    let t = this;
                    t.savings.regular_income.addData.income_starts=t.customFormatter(t.savings.regular_income.addData.income_starts);
                    t.savings.regular_income.addData.income_ends=t.customFormatter(t.savings.regular_income.addData.income_ends);
                    ...
                    .then(function(res) {
                        ...
                        if (!res.hasValidationError && !res.validationError) {
                            ...
                            res.error = {}
                                ...
                                t.savings.error = {}
                                // window.location.href = "Saving_RegularExpensedData.php"
                                t.settings.count = Math.ceil(t.savings.regular_income.data.length / 10);
                        t.settings.loaded = true;
                        t.paginate(1);
                            }
