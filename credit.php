                                                    ...
                                                    <tbody>
                                                        <tr style="padding-top:12px; padding-bottom:12px;">
                                                            ...
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Value['0']}}</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Years['0']}}</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Months['0']}}</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Interest_Cost['0']}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td scope="row" style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                Credit Card Using Tool</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Value['1']}}</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Years['1']}}</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Months['1']}}</td>
                                                            <td style="padding-top:12px; padding-bottom:12px;font-weight:400;">
                                                                {{credit.output.loan_term_comparison.Interest_Cost['1']}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
