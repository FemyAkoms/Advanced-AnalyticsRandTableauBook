                                ...
                                <div>
                                    <div style="overflow-x:auto;border-bottom-right-radius: 25px;
                                        ...
                                        <table v-show="credit.output.months.length<1">
                                            <tr class="table_row_design2" style="background-color: #edf1f9;height:325px">
                                        ...
                                        <table v-show="credit.output.months.length>0">
                                            <tr class="table_row_design">
                                                <th style="padding-left: 20px">P&I & HELOC DETAILS</th>
                                                <th v-for="(v,i) in credit.output.months">{{v}}</th>
                                            </tr>
                                            <tr class="table_row_design1">
                                                <td style="padding-left: 20px">{{key0}}</td>
                                                <td v-for="(v,i) in credit.output.data.Original_Credit_Card_Balance">$ {{formatAmt(v)}}</td>
                                            </tr>
                                            <tr class="table_row_design2">
                                                <td style="padding-left: 20px">{{key1}}
                                                </td>
                                                <td v-for="(v,i) in credit.output.data.Amount_to_be_deposited_on_nanth">$ {{formatAmt(v==null?0:v)}}</td>
                                            </tr>
                                            <tr class="table_row_design1">
                                                <td style="padding-left: 20px">{{key2}}</td>
                                                <td v-for="(v,i) in credit.output.data.Amount_Owed_on_CC_before_Statement_Date">$ {{formatAmt(v==null?0:v)}}</td>

                                            </tr>
                                            <tr class="table_row_design2">
                                                <td style="padding-left: 20px">{{key3}} 
                                                </td>
                                                <td v-for="(v,i) in credit.output.data.Statement_on_nanth">$ {{formatAmt(v==null?0:v)}}</td>
                                            </tr>
                                            <tr class="table_row_design1">
                                                <td style="padding-left: 20px">{{key4}}</td>
                                                <td v-for="(v,i) in credit.output.data.Expense_To_be_withdrawn_on_nanth">$ {{formatAmt(v==null?0:v)}}</td>
                                            </tr>

                                            <tr class="table_row_design2">
                                                <td style="padding-left: 20px">{{key5}}</td>
                                                <td v-for="(v,i) in credit.output.data.Present_Amount_Owed_on_CC_after_Expense_withdrawl">$ {{formatAmt(v==null?0:v)}}</td>
                                            </tr>
                                            <tr class="table_row_design2">
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                getCreditCardDebit: function() {
                    ...
                    $('.trans').fadeIn("slow");
                    if (t.credit.output.months.length > 0) {
