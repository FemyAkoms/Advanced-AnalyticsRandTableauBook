        ...
        <div class="">
            ...
            <div class="desk">
                ...
                <div style=" padding-left: 10px;">
                    <a id="demo" class="row mb-2 px-4 formyaccountde1 " style="cursor:pointer;margin-top:15px" v-show="toolData.selectedType == 1" href="mortgage_input">
                        <div class="col-1"><i class="fas fa-file-export" style="font-size: 14px; color: white;"></i></div>
                        <div class="col-10 ttt">
                            Input Data
                        </div>
                    </a>
                    <a id="demo" class="row mb-2 px-4 formyaccountde1 " style="cursor:pointer;margin-top:15px" v-show="toolData.selectedType == 1 " href="Input_CurrentDebt">
                        <div class="col-1"><i class="fas fa-file-export" style="font-size: 14px; color: white;"></i></div>
                        <div class="col-10 ttt">
                            Current Debt
                        </div>
                    </a>
                    <a id="demo" class="row mb-2 px-4 formyaccountde1 " style="cursor:pointer;margin-top:15px" v-show="toolData.selectedType == 1 " href="Input_LumpSumIncome">
                        <div class="col-1"><i class="fas fa-file-export" style="font-size: 14px; color: white;"></i></div>
                        <div class="col-10 ttt">
                            Lumpsum Income
                        </div>
                    </a>
                    <a id="demo" class="row mb-2 px-4 formyaccountde1 " style="cursor:pointer;margin-top:15px" v-show="toolData.selectedType == 1 " href="Input_LumpSumExpenses">
                        <div class="col-1"><i class="fas fa-file-export" style="font-size: 14px; color: white;"></i></div>
                        <div class="col-10 ttt">
                            Lumpsum Expenses
                        </div>
                    </a>
                    <a id="demo" class="row mb-2 px-4 formyaccountde1 " style="cursor:pointer;margin-top:15px" v-show="toolData.selectedType == 1 " href="Input_RegularExpensedData">
                        <div class="col-1"><i class="fas fa-file-export" style="font-size: 14px; color: white;"></i></div>
                        <div class="col-10 ttt">
                            Regular Expenses
                        </div>
                    </a>
                    <a id="demo" class="row mb-2 px-4 formyaccountde1 " style="cursor:pointer;margin-top:15px" v-show="toolData.selectedType == 1 " href="Input_RegularIncomeData">
                        <div class="col-1"><i class="fas fa-file-export" style="font-size: 14px; color: white;"></i></div>
                        <div class="col-10 ttt">
                            Regular Income
                        </div>
